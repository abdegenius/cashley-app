...
export function EnterPin({ otp, show, setOtp, headerText, buttonText, onConfirm, onBack }: EnterPinProps) {
    ...
    return (
        ...
        <Modal show={show} onClose={() => setActive(false)}>
            <div className="w-full flex flex-col items-center justify-center space-y-10 py-8 px-4 bg-card rounded-t-3xl">
                <button onClick={onBack} className="absolute top-4 left-4 text-gray-100 hover:text-gray-200">
                    <X size={24} />
                </button>
