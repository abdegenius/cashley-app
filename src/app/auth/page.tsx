        ...
        return (
          <div className="w-full flex flex-col space-y-2">
            ...
            <h3 className="text-md placeholder-text">
              Easily recharge any mobile network on Cashley within seconds and stay connected
              anytime, anywhere.
            </h3>
          </div>
        );
      case 1:
        return (
          <div className="w-full flex flex-col space-y-2">
            ...
            <h3 className="text-md placeholder-text">
              Receive crypto, usdt, and other major cryptocurrencies directly no middlemen, no
              delays.
            </h3>
          </div>
        );
      case 2:
        return (
          <div className="w-full flex flex-col space-y-2">
            ...
            <h3 className="text-md placeholder-text">
              Send and receive naira instantly, no delays, no worries. Enjoy smooth, secure
              transactions that work always.
            </h3>
          </div>
        );
      case 3:
        return (
          <div className="w-full flex flex-col space-y-2">
            ...
            <h3 className="text-md placeholder-text">
              Settle your DSTV, GOTV, and other utility bills instantly with zero hidden fees. Fast,
    ...
    <div className="w-full h-full max-w-lg items-center mx-auto flex flex-col justify-between pt-4">
      ...
      >
        <div className="w-full h-full flex items-center justify-center py-8">
          <Image src={"/svg/keyboard.svg"} alt="KeyBoard" width={300} height={300} />
        </div>
        <div className="flex gap-3 justify-center w-full">
          {Array.from({ length: 4 }).map((_, index) => (
            <span
              key={index}
              className={`${step === index ? "bg-white" : "bg-card"} rounded-full w-4 h-4`}
            ></span>
          ))}
        </div>
