...
export default function Profile() {
  return (
    <div className="w-full h-full flex flex-col gap-10">
      <div className="w-full bg-card rounded-xl gap-1 py-3 flex flex-col items-center justify-center">
        ...
        <div>@Nanzing</div>
        <div className="py-2 px-6 bg-background rounded-3xl flex gap-1 items-center text-green-600">
          <span>Verified</span>
          <CircleAlert size={16} />
        </div>
      </div>
      ...
      <div className="w-full bg-card rounded-xl gap-3 py-6 px-3 sm:px-20  flex flex-col items-start justify-start">
