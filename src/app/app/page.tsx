...
export default function Home() {
  ...
  const services = [
    { name: "Airtime", icon: <Phone size={24} className="purple-text" />, link: "/app/airtime" },
    { name: "Data", icon: <Wifi size={24} className="purple-text" />, link: "/app/data" },
    { name: "TV", icon: <Tv size={24} className="purple-text" />, link: "/app/tv" },
    { name: "Crypto", icon: <Bitcoin size={24} className="purple-text" />, link: "/app/crypto" },
    { name: "Savings", icon: <PiggyBank size={24} className="purple-text" />, link: "/app/savings" },
  ];
  return (
